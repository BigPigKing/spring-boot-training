...
public class Users extends TableImpl<UsersRecord> {
     ...
     */
    public final TableField<UsersRecord, String> ACCOUNT = createField(DSL.name("account"), SQLDataType.VARCHAR(20).nullable(false), this, "");

    /**
     * The column <code>cht_newcomer_training.users.password</code>.
     */
    public final TableField<UsersRecord, String> PASSWORD = createField(DSL.name("password"), SQLDataType.VARCHAR(6000).nullable(false), this, "");
